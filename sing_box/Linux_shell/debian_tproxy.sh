...
# 配置参数
BACKEND_URL="http://192.168.23.129:5000"                       # 后端服务器地址
SUBSCRIPTION_URL="http://192.168.23.1:5500/1.txt"   # 订阅地址 Clash.Meta(mihomo)
TEMPLATE_URL="http://192.168.23.1:5500/fuqiang/sing_box/config/config_tproxy.json"  # 配置模板（确保使用tproxy入站）
