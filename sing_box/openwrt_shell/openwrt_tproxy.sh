...
SUBSCRIPTION_URL="http://192.168.66.103:5500/1.txt"  # 订阅地址
TEMPLATE_URL="https://raw.100069.xyz/banyejiu/https://raw.githubusercontent.com/katrien-tom/fuqiang/refs/heads/main/sing_box/config/config_tproxy.json"  # 配置文件（规则模板)
