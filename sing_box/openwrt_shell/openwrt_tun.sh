...
TEMPLATE_URL="https://raw.100069.xyz/banyejiu/https://raw.githubusercontent.com/katrien-tom/fuqiang/refs/heads/main/sing_box/config/config_tun.json"  # 配置文件（规则模板)
